...
\abstract{}{To determine the relation between the amount of radioactive Nickel ($^{56}Ni$) produced in Type Ia supernovae (SNIa) and the timing of the second maximum ($t_2$) in the Near Infrared (NIR; $YJH$) bands and to  extrapolate Nickel mass values for highly reddened SNIa using this relation} 
...
%We would like to thank Chris Burns for his
