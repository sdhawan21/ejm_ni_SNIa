...
;e functionality in SNooPy for kcorr.

I wanted to know whether this method is correct for calculate the K-corrections at high-z. If not, is there an alternate way to calculate the K-corrections.
